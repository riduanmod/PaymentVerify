...
# ==========================================
# Frontend Serving Routes (নতুন যোগ করা হয়েছে)
# ==========================================
...
async def serve_homepage():
    try:
        ...
        return "<h2>Error: index.html file not found in the repository!</h2>"
...
async def serve_admin_panel():
    try:
        ...
        return "<h2>Error: admin.html file not found in the repository!</h2>"
